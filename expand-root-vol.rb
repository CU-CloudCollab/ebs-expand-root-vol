...
def doit(region, instanceID, targetSizeGiB, cleanupSnapshot=false, cleanupOriginalVolume=false)
...
REGION = 'us-east-1'
INSTANCE_ID = 'i-038aee62c2658973a'
...
if __FILE__ == $PROGRAM_NAME
  doit(
    ...
    INSTANCE_ID,
    11, # targetSizeGiB
    true, # cleanupSnapshot
    true # cleanupOriginalVolume
  )
end
